...
@WebServlet(name = "AdvisorPageServlet", value = "/AdvisorPageServlet")
public class AdvisorPageServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String name="java:global/Assignment_4-1.0-SNAPSHOT/StudentBean!it.unitn.andone.assignment_4.StudentBeanIF";
