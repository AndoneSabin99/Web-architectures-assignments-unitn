package it.unitn.andone.Spreadsheet;
...
public class Cell {
    ...
    //added function to get the id of the cell
    ...
    //added function to be able to use checkCircularDependencies outside
    public boolean isCircularDependent(){
        return this.checkCircularDependencies(this.id);
    }
